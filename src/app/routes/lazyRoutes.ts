// app/routes/lazyRoutes.ts
// All lazy page imports in one place.
...
export const GpsDevicesPage    = lazy(() => import("@/modules/tracking/pages/GpsDevicesPage"));
export const TripsPage         = lazy(() => import("@/modules/tracking/pages/TripsPage"));
export const RoutesPage        = lazy(() => import("@/modules/routes/pages/RoutesPage"));
export const AttendancePage    = lazy(() => import("@/modules/attendance/pages/AttendancePage"));
