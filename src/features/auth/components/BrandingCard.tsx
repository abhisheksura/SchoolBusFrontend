// ─── BrandingCard ────────────────────────────────────────────────────────────
// Left panel of the login page (60% width on desktop).
// Shows the product brand, a bold tagline, platform statistics, and
// a decorative SVG background pattern tied to the school bus theme.
        ...
        <div className="relative hidden lg:flex flex-col justify-between w-[60%] min-h-screen overflow-hidden bg-slate-900 px-14 py-12">
            ...
            <div className="relative z-10 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-slate-400 text-xs leading-none mt-0.5 tracking-wide uppercase">
                        School Fleet Platform
                    </p>
                </div>
            </div>
            ...
            {/* ── Bottom: Tags + copyright ───────────────────────────────── */}
            <div className="relative z-10 flex flex-col gap-3">
                <div className="flex flex-wrap gap-2">
                    {["Multi-School", "Role-Based Access", "Live GPS", "Attendance", "Parent Alerts"].map(
                        (tag) => (
                            <span
                                key={tag}
...
// Geometric circuit/route lines evocative of GPS paths on a map.
// ---------------------------------------------------------------------------
...
const BrandingBackground: React.FC = () => (
    <div className="absolute inset-0 z-0" aria-hidden="true">
        ...
        >
            ...
            {/* Highlight route path — mimics a bus route on a map */}
            <polyline
            ...
            {[
                [100, 150], [100, 300], [200, 300],
                [200, 400], [350, 400], [350, 250],
                [500, 250], [500, 500], [400, 650],
            ].map(([cx, cy], i) => (
                <circle
                    key={i}
                    cx={cx}
